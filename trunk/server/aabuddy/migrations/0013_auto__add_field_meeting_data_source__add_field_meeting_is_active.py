...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Meeting.data_source'
        db.add_column(u'aabuddy_meeting', 'data_source',
                      self.gf('django.db.models.fields.CharField')(default='user_submitted', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Meeting.is_active'
        db.add_column(u'aabuddy_meeting', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Meeting.data_source'
        db.delete_column(u'aabuddy_meeting', 'data_source')

        # Deleting field 'Meeting.is_active'
        db.delete_column(u'aabuddy_meeting', 'is_active')
    ...
    models = {
        ...
        u'aabuddy.userconfirmation': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 21, 0, 0)'}),
