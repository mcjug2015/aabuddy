...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserConfirmation'
        db.create_table('aabuddy_userconfirmation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='confirmations', to=orm['auth.User'])),
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 11, 17, 0, 0))),
            ('expiration_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('confirmation_key', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal('aabuddy', ['UserConfirmation'])


    def backwards(self, orm):
        # Deleting model 'UserConfirmation'
        db.delete_table('aabuddy_userconfirmation')
    ...
    models = {
        ...
        'aabuddy.userconfirmation': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 17, 0, 0)'}),
