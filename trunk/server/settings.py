# Django settings for pluginwarehouse project.
from os import path
...
SECRET_KEY = 'PirtshGSHL111Shubniggurauth222!@gergerge'
...
ROOT_URLCONF = 'AaBuddyServerProj.urls'

TEMPLATE_DIRS = (
    # Put strings here, like "/home/html/django_templates" or "C:/www/django/templates".
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    path.join(LOCALPATH, "templates")
)
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_REPORT_RECIPIENTS = ["codecleric@gmail.com"]
