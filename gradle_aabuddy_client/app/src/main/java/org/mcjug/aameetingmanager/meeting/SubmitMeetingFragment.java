...
public class SubmitMeetingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        List<String> meetingTypesToDisplay = new ArrayList<>();
        ...
        if (meetingTypeSelectionText == null) {
            meetingTypeSelectionText = getString(R.string.none);
        }
        ...
        meetingTypesSpinner.setItems(meetingTypesToDisplay, meetingTypeSelectionText, meetingTypeSelectionFlags,
                getString(R.string.none), null,
