...
public class ServiceConfig {
	...
	public ServiceConfig(Context context, DataSourceTypes serviceSourceType) {
		this.dataSourceType = serviceSourceType;
		switch (this.dataSourceType.mDataSourceType) {
			case 0: URL = URL_Simple_Message; break;
			case 1: URL = URL_AA_Meeting; break;
			default: URL = URL_AA_Meeting_Type;  break;
		}		
	}
