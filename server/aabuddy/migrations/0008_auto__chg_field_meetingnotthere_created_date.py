...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MeetingNotThere.created_date'
        db.alter_column('aabuddy_meetingnotthere', 'created_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'MeetingNotThere.created_date'
        db.alter_column('aabuddy_meetingnotthere', 'created_date', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'aabuddy.userconfirmation': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 9, 0, 0)'}),
