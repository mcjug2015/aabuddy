...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MeetingNotThere.created_date'
        db.add_column('aabuddy_meetingnotthere', 'created_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 2, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MeetingNotThere.created_date'
        db.delete_column('aabuddy_meetingnotthere', 'created_date')
