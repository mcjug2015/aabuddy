...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'aabuddy_servermessage', (
            ...
            ('short_message', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'aabuddy', ['ServerMessage'])

    def backwards(self, orm):
        # Deleting model 'ServerMessage'
        db.delete_table(u'aabuddy_servermessage')
    ...
    models = {
        ...
        u'aabuddy.userconfirmation': {
            ...
            'created_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 17, 0, 0)'}),
